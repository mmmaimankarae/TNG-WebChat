          ...
          <div class="flex items-center ml-20 space-x-4">
            <div>
              ...
              <div class="relative">
                ...
                <button data-copy="cusName" id="cusNameCopy" class="absolute inline-flex items-center justify-center py-1.5 px-2 text-blue-600 border border-gray-300 rounded-md hover:bg-gray-100">
                  ...
                  <span id="suc-cusCodecopy" class="hidden items-center">
                    <svg class="w-3 h-3 me-1.5 text-blue-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
              ...
              <div class="relative mt-2.5">
                ...
                <input id="cusName" type="text" value="{{ $cusCode }}" class="w-8/12 truncate" disabled readonly>
                <button data-copy="cusName" id="cusNameCopy" class="absolute inline-flex items-center justify-center py-1.5 px-2 text-red-600 border border-gray-300 rounded-md hover:bg-gray-100">
                  ...
                  <span id="suc-cusNamecopy" class="hidden items-center">
                    <svg class="w-3 h-3 me-1.5 text-red-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5"/>
                    </svg>
                    <span class="text-xs font-semibold text-red-700">Copied</span>   
                  </span>
                </button>
              </div>
