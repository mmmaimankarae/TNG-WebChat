...
<nav class="sticky top-0 z-30 py-0.5 text-sm font-medium tracking-wider bg-white shadow-md ">
  <div class="flex items-center mx-auto w-full h-12 px-2 sm:px-3 lg:px-5">
    ...
    <div class="hidden sm:flex sm:ml-6 space-x-6 lg:space-x-10"> 
      <a href="{{ route('it-support.employee') }}" class="nav-style" aria-current="false"> เพิ่มพนักงานใหม่</a>
      <a href="{{ route('it-support.product') }}" class="nav-style" aria-current="false"> เพิ่มรายการสินค้า </a>
      <a href="{{ route('it-support.branch') }}" class="nav-style" aria-current="false"> เพิ่มสาขาใหม่ </a>
    </div>
    ...
    <div id="menu-buger" class="hidden sm:hidden fixed top-12 left-0 right-0 px-2 pt-2 pb-3 space-y-1 bg-white shadow-md">
      <a href="{{ route('it-support.employee') }}" class="nav-style block" aria-current="false"> เพิ่มพนักงานใหม่ </a>
      <a href="{{ route('it-support.product') }}" class="nav-style block" aria-current="false"> เพิ่มรายการสินค้า </a>
      <a href="{{ route('it-support.branch') }}" class="nav-style block" aria-current="false"> เพิ่มสาขาใหม่ </a>
