...
<nav class="sticky top-0 z-20 py-0.5 text-sm font-medium tracking-wider bg-white shadow-md ">
  <div class="flex items-center mx-auto w-full h-12 px-2 sm:px-3 lg:px-5">
    {{-- LOGO --}}
    <a href="{{ route('sale-admin.new-tasks') }}" class="flex-shrink-0"><img class="w-auto h-10" src="{{ asset('images/logo.png') }}" alt="logo"></a>
    {{-- Navigation Menu --}}
    <div class="hidden sm:flex sm:ml-6 space-x-6 lg:space-x-10"> 
      <a href="{{ route('sale-admin.new-tasks') }}" class="nav-style" aria-current="false">
      ...
      <a href="{{ route('sale-admin.credit-debit') }}" class="nav-style inline-flex items-center" aria-current="false">เพิ่มหนี้/ลดหนี้</a>
      <a href="#" class="nav-style inline-flex items-center" aria-current="false">จัดทำโปรโมชั่น</a>
    </div>
    ...
    <div id="menu-buger" class="hidden sm:hidden fixed top-12 left-0 right-0 px-2 pt-2 pb-3 space-y-1 bg-white shadow-md">
      ...
      <a href="{{ route('sale-admin.credit-debit') }}" class="nav-style block" aria-current="false">เพิ่มหนี้/ลดหนี้</a>
      <a href="#" class="nav-style block" aria-current="false">จัดทำโปรโมชั่น</a>
